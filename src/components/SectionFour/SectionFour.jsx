    ...
    <section className="section-four-background">
      ...
      <div className="pt-[30vw] lg:pt-16 px-10 md:px-20 flex flex-col lg:flex-row lg:justify-between gap-5">
        <p className="font-manjari font-semibold text-sm md:text-base xl:text-xl lg:w-1/3 lg:text-left">
          ...
          crafting each cup with a blend of expertise and passion that has stood
          the test of time. As we mark over three decades of serving our
        ...
        <p className="font-manjari font-semibold text-sm md:text-base xl:text-xl lg:w-1/3 lg:text-right">
          With a legacy rooted in meticulous craftsmanship and dedication to our
          craft, EspressoZen Cafe has been a beloved destination since 1987.
          From our humble beginnings to becoming a cherished part of daily
          routines, we continue to elevate the coffee experience, welcoming each
          guest to share in our journey of flavor, tradition, and excellence.
        </p>
      </div>
      <div className="px-10 md:px-20 flex flex-col items-center lg:pt-10 xl:pt-0">
        <p className="font-manjari font-semibold text-sm md:text-base xl:text-xl pt-6 pb-2">
          ...
          tradition and innovation in every sip, as we continue to redefine the
          art of coffee since 1987.
        </p>
